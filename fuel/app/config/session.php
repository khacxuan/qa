...
return array(
	...
	*/
	...
	'cookie'			=> array(
		'cookie_name'		=> 'QAcid',				// name of the session cookie for cookie based sessions
						),

	// specific configuration settings for file based sessions
	'file'				=> array(
		'cookie_name'		=> 'QAfid',				// name of the session cookie for file based sessions
	...
	'memcached'			=> array(
		'cookie_name'		=> 'QAmid',				// name of the session cookie for memcached based sessions
	...
	'db'			=> array(
		'cookie_name'		=> 'QAdid',				// name of the session cookie for database based sessions
	...
	'redis'			=> array(
		'cookie_name'		=> 'QArid',				// name of the session cookie for redis based sessions
