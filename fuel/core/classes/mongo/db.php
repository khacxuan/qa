...
class Mongo_Db
{
	 ...
	 *
	 *	@param	mixed $code : a MongoCode or string to execute.
	 *  @param	array $args : Arguments to be passed to code.
	 *	@usage	$mongodb->execute("function(greeting, name) { return greeting+', '+name+'!'; }", array("Good bye", "Joe"));
	 */
	public function execute($code , $args = array())
	{
		try
		{
			$run = $this->db->execute($code , $args);
			return $run;
		}
